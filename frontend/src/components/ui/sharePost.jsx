...
export function SharePost(){
    return(
        <div className="main-share-post-container p-6 flex flex-col space-y-4 bg-white border border-blue-200 rounded-3xl shadow-md">
            <div className="flex items-start space-x-4">
                {/* Text Area */}
                <textarea
                className="w-[95%] p-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none bg-gray-100"
                ...
                {/* Submit Button */}
                <button className="submit-post-button w-12 h-12 bg-blue-500 text-white rounded-full font-semibold flex items-center justify-center hover:bg-blue-600 mt-2">
